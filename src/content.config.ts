...
const pagesCollection = defineCollection({
  ...
  schema: z.object({
    ...
    // === INICIO ===
    hero_cta_primary: bi.optional(),
    hero_cta_secondary: bi.optional(),
    pillars_eyebrow: bi.optional(),
    ...
    featured_eyebrow: bi.optional(),
    featured_title: bi.optional(),
    featured_cta: bi.optional(),
    vision_quote: bi.optional(),
    newsletter_eyebrow: bi.optional(),
    newsletter_title: bi.optional(),
    newsletter_subtitle: bi.optional(),
    newsletter_placeholder: bi.optional(),
    newsletter_cta: bi.optional(),
    // === INSTITUCIONAL ===
